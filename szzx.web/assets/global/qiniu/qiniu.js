...
function() {
	...
	function(t, e, n) {
		...
		s = function(t, e, n) {
		    ...
		    for (a in p && (n = e), n)(c = !l && b && void 0 !== b[a]) && a in m || (f = c ? b[a] : n[a], m[a] = p && "function" != typeof b[a] ? n[a] : v && c ? i(f, r) : y && b[a] == f ?
			function(t) {
	...
	function(t, e, n) {
		...
		e.filterParams = o,
		e.getLocalFileInfoAndMd5 = function(t) {
		    return new l.
		default(function(e, n) {
		    a(t).then(function(n) {
		        var r = new v.
		...
		e.setLocalFileInfo = function(t, e, n) {
		    try {
		        localStorage.setItem(i(t, e), (0, f.
			default)(n))
		    } catch(t) {
		...
		e.createMkFileUrl = function(t, e, n, r) {
		    var i = t + "/mkfile/" + e;
		    null != n && (i += "/key/" + (0, h.urlSafeBase64Encode)(n)),
			r.mimeType && (i += "/mimeType/" + (0, h.urlSafeBase64Encode)(r.mimeType));
		    var u = r.fname;
		    return u && (i += "/fname/" + (0, h.urlSafeBase64Encode)(u)),
			r.params && o(r.params).forEach(function(t) {
			    return i += "/" + encodeURIComponent(t[0]) + "/" + (0, h.urlSafeBase64Encode)(t[1])
			}),
			i
		},
		...
		e.getUploadUrl = function(t) {
		    var e = d.regionUphostMap[t.region] || d.regionUphostMap[d.region.z0];
		    return ("https:" === window.location.protocol ? "https": "http") + "://" + (t.useCdnDomain ? e.cdnUphost: e.srcUphost)
		},
	...
	function(t, e, n) {
	    ...
	    t.exports = function(t, e, n, v, y, m, g) {
			...
			C = !1,
			P = t.prototype,
			U = P[p] || P["@@iterator"] || y && P[y],
			M = !h && U || x(y),
			O = y ? k ? x("entries") : M: void 0,
			A = "Array" == e && P.entries || U;
	        if (A && (w = l(A.call(new t))) !== Object.prototype && w.next && (f(w, S, !0), r || s(w, p) || u(w, p, d)), k && U && "values" !== U.name && (C = !0, M = function() {
				return U.call(this)
	...
	function(t, e, n) {
		...
		a = function() {
		    var t, e = n(23)("iframe"),
			r = i.length;
		    for (e.style.display = "none", n(48).appendChild(e), e.src = "javascript:", (t = e.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), a = t.F; r--;) delete a.prototype[i[r]];
		    return a()
		};
	    t.exports = Object.create ||
		function(t, e) {
		    var n;
		    return null !== t ? (s.prototype = r(t), n = new s, s.prototype = null, n[u] = t) : n = a(),
			void 0 === e ? n: o(n, e)
		}
	},
	function(t, e, n) {
	...
	function(t, e, n) {
	    n(71);
	    for (var r = n(0), o = n(5), i = n(14), u = n(1)("toStringTag"), s = "CSSRuleList,CSSStyleDeclaration,CSSValueList,ClientRectList,DOMRectList,DOMStringList,DOMTokenList,DataTransferItemList,FileList,HTMLAllCollection,HTMLCollection,HTMLFormElement,HTMLSelectElement,MediaList,MimeTypeArray,NamedNodeMap,NodeList,PaintRequestList,Plugin,PluginArray,SVGLengthList,SVGNumberList,SVGPathSegList,SVGPointList,SVGStringList,SVGTransformList,SourceBufferList,StyleSheetList,TextTrackCueList,TextTrackList,TouchList".split(","), a = 0; a < s.length; a++) {
	        var c = s[a],
			f = r[c],
			l = f && f.prototype;
	        l && !l[u] && o(l, u, c),
	...
	function(t, e, n) {
		    ...
		    if (!t._n) {
		        ...
		        g(function() {
					...
					function(e) {
						...
						c = e.domain;
					    try {
					        u ? (o || (2 == t._h && j(t), t._h = 1), !0 === u ? n = r: (c && c.enter(), n = u(r), c && c.exit()), n === e.promise ? a(x("Promise-chain cycle")) : (i = O(n)) ? i.call(n, s, a) : s(n)) : a(r)
					    } catch(t) {
					        a(t)
					    }
					} (n[i++]);
		...
		L = function(t) {
		    ...
		    if (!n._d) {
				...
				n = n._w || n;
		        try {
		            if (n === t) throw x("Promise can't be resolved itself"); (e = O(t)) ? g(function() {
		                var r = {
		                    _w: n,
		                    _d: !1
		                };
	    ...
	    r = function(t) {
			...
			function() {
			    ...
			    ArrayBuffer.prototype.slice = function(n, r) {
					...
					f = a;
			        return r !== t && (f = e(r, a)),
					c > f ? new ArrayBuffer(0) : (o = f - c, i = new ArrayBuffer(o), u = new Uint8Array(i), s = new Uint8Array(this, c, o), u.set(s), i)
			    }
			} (),
	...
	function(t, e, n) {
	    ...
	    e.UploadManager = function() {
	        ...
	        return t.prototype.putFile = function() {
	            var t = this;
	            if (this.putExtra.fname || (this.putExtra.fname = this.file.name), this.putExtra.mimeType && this.putExtra.mimeType.length && !(0, s.isContainFileMimeType)(this.file.type, this.putExtra.mimeType)) {
	                var e = new Error("file type doesn't match with what you specify");
	                return this.onError(e),
					o.
				default.reject(e)
	            }
	            this.uploadUrl = (0, s.getUploadUrl)(this.config),
				this.uploadAt = (new Date).getTime();
	            var n = this.file.size > 4194304 ? this.resumeUpload() : this.directUpload();
				...
				function(e) {
				    t.onError(e),
					e.isRequestError && !t.config.disableStatisticsReport && (0 !== e.code ? t.sendLog(e.reqId, e.code) : t.sendLog("", -2)),
					t.stop()
				}),
				n
	        },
			...
			t.prototype.resumeUpload = function() {
				...
				(0, s.getLocalFileInfoAndMd5)(this.file).then(function(e) {
				    t.ctxList = [];
				    var n = e.md5;
				    t.localInfo = e.info,
					t.chunks = (0, s.getChunks)(t.file, 4194304),
					t.initChunksProgress();
				    var r = t.chunks.map(function(e, n) {
				        return t.uploadChunk(e, n)
				    }),
					i = o.
				default.all(r).then(function() {
				    return t.mkFileReq()
				});
				    return i.then(function(e) { (0, s.removeLocalFileInfo)(t.file.name, n)
				    },
					function(e) {
					    701 === e.code ? (0, s.removeLocalFileInfo)(t.file.name, n) : (0, s.setLocalFileInfo)(t.file.name, n, t.ctxList)
					}),
					i
				})
			},
			t.prototype.uploadChunk = function(t, e) {
			    var n = this,
				r = this.localInfo[e];
			    if (r && !(0, s.isChunkExpired)(r.time)) return this.updateChunkProgress(t.size, e),
				this.ctxList[e] = {
				    ctx: r.ctx,
				    time: r.time
				},
			...
			default.resolve();
			    ...
			    return (0, s.readAsArrayBuffer)(t).then(function(t) {
			        var r = (0, s.getHeadersForChunkUpload)(n.token),
					o = n.xhrHandler;
			        return (0, s.request)(i, {
			            method: "POST",
			            headers: r,
			            body: t,
			...
			t.prototype.updateDirectProgress = function(t, e) {
			    this.progress = {
			        total: this.getProgressInfoItem(t, e)
			    },
	...
	function(t, e, n) {
	    ...
	    function u(t, e, n) {
	        ...
	        if (2 === o) {
	            ...
	            i += s ? "/text/" + (0, a.urlSafeBase64Encode)(s) : "",
				i += c ? "/font/" + (0, a.urlSafeBase64Encode)(c) : "",
				i += f ? "/fontsize/" + f: "",
				i += l ? "/fill/" + (0, a.urlSafeBase64Encode)(l) : ""
	        }
	        var p = t.dissolve,
			h = t.gravity,
			d = t.dx,
	...
	function(t, e, n) {
		...
		H = "function" == typeof E,
		N = r.QObject,
		D = !N || !N.prototype || !N.prototype.findChild,
		G = i && c(function() {
		    return 7 != S(O({},
			"a", {
			    get: function() {
		...
		W = function(t, e, n) {
			...
			e = w(e, !0),
			g(n),
			o(q, e) ? (n.enumerable ? (o(t, F) && t[F][e] && (t[F][e] = !1), n = S(n, {
			    enumerable: x(0, !1)
			})) : (o(t, F) || O(t, F, x(1, {})), t[F][e] = !0), G(t, e, n)) : O(t, e, n)
		},
		X = function(t, e) {
		    g(t);
		...
		Y = function(t) {
		    for (var e, n = A(_(t)), r = [], i = 0; n.length > i;) o(q, e = n[i++]) || e == F || e == a || r.push(e);
		    return r
		},
		Q = function(t) {
		    for (var e, n = t === z,
			r = A(n ? B: _(t)), i = [], u = 0; r.length > u;) ! o(q, e = r[u++]) || n && !o(z, e) || i.push(q[e]);
		    return i
		};
	    H || (s((E = function() {
		...
		function() {
		    return this._k
		}), C.f = $, P.f = W, n(57).f = k.f = Y, n(20).f = K, n(30).f = Q, i && !n(21) && s(z, "propertyIsEnumerable", K, !0), d.f = function(t) {
		    return V(h(t))
		}),
		u(u.G + u.W + u.F * !H, {
		    Symbol: E
	    ...
	    for (var et = U(h.store), nt = 0; et.length > nt;) v(et[nt++]);
	    u(u.S + u.F * !H, "Symbol", {
	        for: function(t) {
		...
		E.prototype[L] || n(5)(E.prototype, L, E.prototype.valueOf),
		l(E, "Symbol"),
		l(Math, "Math", !0),
		l(r.JSON, "JSON", !0)
	},
